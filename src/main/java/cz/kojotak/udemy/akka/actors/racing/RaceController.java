...
public class RaceController extends AbstractBehavior<RaceController.Command>{
	...
	public static class RacerFinished implements Command{
		...
		public RacerFinished(ActorRef<cz.kojotak.udemy.akka.actors.racing.AkkaRacer.Command> racer) {
			super();
			this.racer = racer;
		}
	...
	public static class RacerUpdate implements Command {
		...
		public RacerUpdate(ActorRef<cz.kojotak.udemy.akka.actors.racing.AkkaRacer.Command> racer, int position) {
			super();
			this.racer = racer;
